...
export default function RatTrackerApp() { // main app
  ...
  // Kittens flattened for optional display in Rats list
...
function LitterOverview({ litter, rats, onViewRat }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs opacity-70">
        Tip: Click a kitten&apos;s “Keep as rat” in the Litters tab to promote it to the Rats list. Then you can view its tree here.
      </div>
    </div>
  );
}
